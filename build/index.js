...
/***/ "./src/assets/compiled.js":
/*!********************************!*\
  !*** ./src/assets/compiled.js ***!
  \********************************/
/*! exports provided: awesomepackage, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "awesomepackage", function() { return awesomepackage; });
...
const awesomepackage = $root.awesomepackage = (() => {
    ...
    awesomepackage.AwesomeMessage = (function() {
        ...
        AwesomeMessage.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.awesomepackage.AwesomeMessage();
            ...
            if (!message.hasOwnProperty("awesomeField"))
                throw $util.ProtocolError("missing required 'awesomeField'", { instance: message });
            return message;
        };
        ...
        AwesomeMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.awesomepackage.AwesomeMessage)
                return object;
            let message = new $root.awesomepackage.AwesomeMessage();
...
console.log(_assets_compiled_js__WEBPACK_IMPORTED_MODULE_0__);
...
var buffer = Awesome.encode(message).finish();
console.log(buffer);
